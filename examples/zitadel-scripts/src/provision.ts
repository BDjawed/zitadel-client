...
async function main(): Promise<void> {
  if (
    ...
    throw new Error(
      'Please provide ZITADEL_INSTANCE_URL, ZITEDEL_KEY_FILE_PATH, ZITADEL_HUMAN_USER_PASSWORD, ZITADEL_MACHINE_USER_PAT_EXPIRATION_DATE, ZIDATEL_APP_OIDC_REDIRECT_URI in .env file',
    )
  }
