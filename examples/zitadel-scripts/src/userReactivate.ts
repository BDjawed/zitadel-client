...
async function main(): Promise<void> {
  ...
  console.log('Reactivating Machine Users...')
  ...
  const reactivatedCreLandMachineUsers: ZITADEL.ZitadelMachineUserUpdateResponse[] = []
  ...
  for (const machineUser of ZITADEL_PROVISIONING_RESPONSE_FILE.machineUsers) {
    ...
    const creLandMachineUserReactivateResponse = await zitadelClient.userReactivate(userId)
    reactivatedCreLandMachineUsers.push(creLandMachineUserReactivateResponse)
  }

  console.log('CreLand Machine Users reactivated', reactivatedCreLandMachineUsers)
}
main()
