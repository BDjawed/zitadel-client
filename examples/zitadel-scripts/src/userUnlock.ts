...
async function main(): Promise<void> {
  ...
  console.log('Unlocking Machine Users...')
  ...
  const unlockedCreLandMachineUsers: ZITADEL.ZitadelMachineUserUpdateResponse[] = []
  ...
  console.log('CreLand Machine Users unlocked', unlockedCreLandMachineUsers)
}
main()
